(function() {
  var Compose, Promise, Stream, Vinyl, parse, path;
      ...
      wrapFile(file) {
        return Promise.resolve().then(() => {
          ...
          if (file.wrapped != null) {
            return (file.wrapped.promise || Promise.resolve()).then(() => {
              if (file.wrapped.dependencies) {
            ...
            return file.wrapped.promise = Promise.map(dependencies, (dependency) => {
