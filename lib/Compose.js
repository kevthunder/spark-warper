(function() {
  ...
  module.exports = Compose = (function(superClass) {
    ...
    Compose.prototype.getProcessedByRef = function(module, ref) {
      ...
      find = function(file) {
        var ref1;
        return ((ref1 = file.wrapped) != null ? ref1.module : void 0) === module && ref.indexOf(file.wrapped.className) === 0;
      };
      return Promise.resolve().then((function(_this) {
        return function() {
          var file;
    ...
    Compose.prototype.resolveDependency = function(dependency, file) {
      ...
      return Promise.resolve().then((function(_this) {
        return function() {
          var dependencyPath, module, ref;
          if ((_this.opt.aliases != null) && (match = /require(\(|\s*)['"]([^'"]+)['"]\)?/.exec(dependency.def)) && (_this.opt.aliases[match[2]] != null)) {
            dependency.def = dependency.def.replace(match[0], _this.opt.aliases[match[2]]);
            return null;
      ...
      return Promise.resolve().then((function(_this) {
        ...
        return function() {
          ...
          for (i = 0, len = ref1.length; i < len; i++) {
            file = ref1[i];
            if (((ref2 = file.wrapped) != null ? ref2.special : void 0) === 'start' && file.wrapped.namespace !== _this.opt.namespace) {
              _this.push(file);
            }
          }
          ...
          for (j = 0, len1 = ref3.length; j < len1; j++) {
            file = ref3[j];
            if (!(((ref4 = file.wrapped) != null ? ref4.special : void 0) === 'end' || ((ref5 = file.wrapped) != null ? ref5.special : void 0) === 'start')) {
